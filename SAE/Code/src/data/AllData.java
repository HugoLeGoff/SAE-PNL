...
public class AllData {
  ...
  public ArrayList<AfficheObsChouette> chouetteAnnee(String annee) throws SQLException{
    ...
    Connection c = DriverManager.getConnection("jdbc:mysql://localhost:3306/bd_pnr", "admin", "mdp_admin");
    Statement stmt = c.createStatement();
    ResultSet res = stmt.executeQuery("SELECT * FROM obs_chouette JOIN Observation ON numObs = idObs LEFT JOIN Aobserve ON idObs = lobservation LEFT JOIN observateur ON lobservateur = idObservateur WHERE YEAR (dateObs) = "+annee+";");
  ...
  public ArrayList<AfficheObsLoutre> loutreAnnee(String annee) throws SQLException{
    ...
    Connection c = DriverManager.getConnection("jdbc:mysql://localhost:3306/bd_pnr", "admin", "mdp_admin");
    Statement stmt = c.createStatement();
    ResultSet res = stmt.executeQuery("SELECT * FROM Obs_Loutre LEFT JOIN Observation ON ObsL = idObs LEFT JOIN Aobserve ON idObs = lobservation LEFT JOIN observateur ON lobservateur = idObservateur WHERE YEAR (dateObs) = "+annee+";");
  ...
  public ArrayList<AfficheObsGCI> gciAnnee(String annee) throws SQLException{
    ...
    Connection c = DriverManager.getConnection("jdbc:mysql://localhost:3306/bd_pnr", "admin", "mdp_admin");
    Statement stmt = c.createStatement();
    ResultSet res = stmt.executeQuery("SELECT * FROM Obs_GCI LEFT JOIN Nid_GCI ON idNid = leNid LEFT JOIN Observation ON obsG = idObs  LEFT JOIN Aobserve ON idObs = lobservation LEFT JOIN observateur ON lobservateur = idObservateur WHERE YEAR (dateObs) = "+annee+";");
  ...
  public ArrayList<AfficheObsBatracien> BatracienAnnee(String annee) throws SQLException{
    ...
    Connection c = DriverManager.getConnection("jdbc:mysql://localhost:3306/bd_pnr", "admin", "mdp_admin");
    Statement stmt = c.createStatement();
    ResultSet res = stmt.executeQuery("SELECT *  FROM Obs_Batracien  JOIN Observation ON obsB = idObs  JOIN Aobserve ON idObs = lobservation  JOIN observateur ON lobservateur = idObservateur JOIN ZoneHumide ON concerne_ZH = zh_id JOIN Vegetation ON concernes_vege = idVege JOIN Lieu_Vegetation ON idVegeLieu = decrit_LieuVege WHERE YEAR (dateObs) = "+annee+";");
